...
🔹 **Resultados**: Comparación de modelos y evaluación de métricas para optimizar la predicción de precios inmobiliarios.

### 4️⃣ **Segmentación de Imágenes de Huellas Dactilares**
🔹 **Descripción**: Implementación de un algoritmo de segmentación para imágenes de huellas dactilares basado en la magnitud del gradiente y detección de regiones.
🔹 **Metodología**:

Uso de operadores de gradiente para detectar bordes.
Identificación y separación de la región de interés de la imagen.
Evaluación con imágenes de la Fingerprint Verification Competition (FVC).
🔹 **Herramientas**: Python (OpenCV, NumPy, Matplotlib).
🔹 **Resultados**: La estrategia de segmentación replicada mostró resultados efectivos en la separación de la huella del fondo, validando su desempeño frente a técnicas existentes.
